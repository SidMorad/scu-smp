<?php
/**
 * Created at 13/09/2010 12:05:40 PM
 * smp/view/course/edit.php
 *
...
if ($objForm->isPost()) {
	...
	$course = $request->getEntity();
	$objForm->setValue('id', $course->getId());
	$objForm->setValue('name', $course->getName());
}

print $objForm->open("courseForm");
print $objForm->hidden("cmd"		, "course/edit");
print $objForm->hidden("id"		, "");
...
print $objForm->submitAndResetButton("button", "Update", "Reset", 2, "grid_10", "button");
print $objForm->close();
