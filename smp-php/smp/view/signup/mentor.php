...
print $objForm->selectBox("studyMode"		, "", "", 12, 			"grid_6", VH::getFixArray('study_mode'));
...
print $objForm->textBox("course"			, "", "", 14, 			"grid_6");
...
print $objForm->redioBox("firstYearComplete", 		  16,			"grid_6", VH::getFixArray('yes_no'));
...
print $objForm->checkBox("international"	, "", 	  19, 			"grid_6");
...
print $objForm->redioBox("isLowSocioeconomic",		  35, 			"grid_6", VH::getFixArray('yes_no'));
print $objForm->label(""					, "&nbsp;", 			"grid_6");
print $objForm->label("isNonEnglish"		, "Student from non-English speaking background:","grid_6");
print $objForm->redioBox("isNonEnglish"		,		  36, 			"grid_6", VH::getFixArray('yes_no'));
print $objForm->label("isIndigenous"		, "Indigenous Australian student:","grid_6");
print $objForm->redioBox("isIndigenous"		,		  37, 			"grid_6", VH::getFixArray('yes_no'));
...
print $objForm->checkBox("agreement"		, "", 	  38, "grid_4", null, false, "checkbox");
