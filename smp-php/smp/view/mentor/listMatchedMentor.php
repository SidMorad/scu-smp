 ...
 * smp/view/mentor/listMatchedMentor.php
 *
...
if (is_null($request->getProperty('output_format'))) {
	...
	include("smp/view/search/mentorSearchExpiredPanel.php");
	...
	print $indent. "	<a href=\"index.php?cmd=mentor/listMatchedMentor&output_format=CSV\">\r\n";
	print $indent. "	<img src=\"static/images/csv.png\" >\r\n";
	print $indent. "	</a>\r\n";
	print $indent. "	<span>&nbsp; | &nbsp;</span>\r\n";
	print $indent. "	<a href=\"index.php?cmd=mentor/listMatchedMentor&output_format=XLS\">\r\n";
