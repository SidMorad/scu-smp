...
$datagrid->addColumn(new Structures_DataGrid_Column('Update', null, null, array('width' => '20%'), null, 'printUpdateLink()'));
...
function printUpdateLink($params) {
...
function printMenteeLimitTextbox($params) {
	...
	$formString .= $formBuilder->textBox('menteeLimit', '',$menteeLimit, 1, NULL,'smallinput',2);
	return $formString;
}
