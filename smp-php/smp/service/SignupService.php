...
class smp_service_SignupService {
	...
	function saveMentee(smp_domain_User $user, smp_domain_Student $student, smp_domain_Contact $contact) {
		return $this->signupMapper->saveMentee($user, $student, $contact);
	}
}